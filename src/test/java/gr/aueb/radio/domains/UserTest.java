...
public class UserTest {
    ...
    @BeforeEach
    public void setup(){
        userEntity = new User("test", "test", "test@email.com",  RoleEnum.USER);
    }
    ...
    public void updateUser(){
        ...
        assertEquals(RoleEnum.USER, userEntity.getRole());
    }
    ...
    public void equalsUserDataTest(String username, String password, String email, RoleEnum role, boolean expectedResult){
