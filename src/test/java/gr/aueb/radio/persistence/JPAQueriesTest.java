...
public class JPAQueriesTest extends IntegrationBase {
    ...
    public void restrictSongBroadcastCreation(){
        ...
        Song invalidSong1 = new Song("title", "hip hop", 190, "artist", 2023);
        ...
        // no broadcast is added
        Song invalidSong2 = new Song("title", "hip hop", 5, "artist", 2023);
        broadcast.createSongBroadcast(invalidSong2, DateUtil.setTime("00:45"));
        assertEquals(listOfSongs, broadcast.getSongBroadcasts().size());
        // exceed limit restriction
        // proposal time is way after ending time of broadcast
        // no broadcast is added
        Song invalidSong3 = new Song("title", "hip hop", 5, "artist", 2023);
        broadcast.createSongBroadcast(invalidSong3, DateUtil.setTime("13:15"));
        assertEquals(listOfSongs, broadcast.getSongBroadcasts().size());
        // exceed limit restriction
        // song will end after the broadcast ending time
        // no broadcast is added
        ...
        // inconsistent song genre
        // no broadcast is added
        invalidSong3.setGenre("whatever");
        broadcast.createSongBroadcast(invalidSong3, broadcastEndingTime.minusMinutes(invalidSong3.getDuration()).toLocalTime());
        assertEquals(listOfSongs, broadcast.getSongBroadcasts().size());
    }
    ...
    public void restrictAddBroadcastCreation(){
        ...
        // total duration restriction
        // no broadcast is added
        Ad invalidAd1 = new Ad(broadcast.getDuration() + 100, 1, DateUtil.setDate("01-01-2022"),  DateUtil.setDate("01-03-2022") , ZoneEnum.LateNight);
        broadcast.createAdBroadcast(invalidAd1, DateUtil.setTime("02:40"));
        assertEquals(listOfAdds, broadcast.getAdBroadcasts().size());
        // invalid timezone restriction
        // no broadcast is added
        Ad invalidAd2 = new Ad(5, 1, DateUtil.setDate("01-01-2022"),  DateUtil.setDate("01-03-2022") , ZoneEnum.Afternoon);
        broadcast.createAdBroadcast(invalidAd2, DateUtil.setTime("02:00"));
        assertEquals(listOfAdds, broadcast.getAdBroadcasts().size());
        // occurrence song restriction
        // no broadcast is added
        Ad invalidAd3 = new Ad(5, 1, DateUtil.setDate("01-01-2022"),  DateUtil.setDate("01-03-2022") , ZoneEnum.LateNight);
        broadcast.createAdBroadcast(invalidAd3, DateUtil.setTime("00:15"));
        assertEquals(listOfAdds, broadcast.getAdBroadcasts().size());
        // exceed limit restriction
        // no broadcast is added
        Ad invalidAd4 = new Ad(5, 1, DateUtil.setDate("01-01-2022"),  DateUtil.setDate("01-03-2022") , ZoneEnum.LateNight);
        broadcast.createAdBroadcast(invalidAd4, DateUtil.setTime("13:15"));
        assertEquals(listOfAdds, broadcast.getAdBroadcasts().size());
        // exceed limit restriction
        // no broadcast is added
        LocalDateTime broadcastEndingTime = broadcast.getBroadcastEndingDateTime();
        broadcast.createAdBroadcast(invalidAd4, broadcastEndingTime.minusMinutes(invalidAd4.getDuration()/2).toLocalTime());
        assertEquals(listOfAdds, broadcast.getAdBroadcasts().size());
        // Add rep_per_zone restriction
        // no broadcast is added
        Ad invalidAd5 = new Ad(10, 0, broadcast.getStartingDate().minusMonths(1), broadcast.getStartingDate().plusMonths(1) , ZoneEnum.LateNight);
        broadcast.createAdBroadcast(invalidAd5, DateUtil.setTime("02:40"));
        assertEquals(listOfAdds, broadcast.getAdBroadcasts().size());

        // Add time range restrictions restriction
        // no broadcast is added
        Ad invalidAd6 = new Ad(10, 0, broadcast.getStartingDate().minusMonths(2),  broadcast.getStartingDate().minusMonths(1) , ZoneEnum.LateNight);
        broadcast.createAdBroadcast(invalidAd6, DateUtil.setTime("02:40"));
        assertEquals(listOfAdds, broadcast.getAdBroadcasts().size());
    }
}
