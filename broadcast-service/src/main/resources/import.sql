...
insert into broadcasts (id, duration, starting_date, starting_time, type, user_id, genre_id) values(3003, 200, PARSEDATETIME('01-03-2022','dd-MM-yyyy'), '00:00', 'PLAYLIST', 6001, 1);
insert into broadcasts (id, duration, starting_date, starting_time, type, user_id, genre_id) values(3004, 200, PARSEDATETIME('01-04-2022','dd-MM-yyyy'), '00:00', 'PLAYLIST', 6001, 1);
...
insert into ad_broadcasts (id, broadcast_date, broadcast_time, ad_id, broadcast_id) values (4003, PARSEDATETIME('01-03-2022','dd-MM-yyyy'), '00:40', 1001, 3003);
insert into ad_broadcasts (id, broadcast_date, broadcast_time, ad_id, broadcast_id) values (4004, PARSEDATETIME('01-04-2022','dd-MM-yyyy'), '00:40', 1001, 3004);
