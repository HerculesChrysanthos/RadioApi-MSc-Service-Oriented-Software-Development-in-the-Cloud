...
insert into songs (id, title, artist, release_year, duration, genre) values(7001, 'Ride', 'Twenty One Pilots', 2015, 25, 1);
insert into songs (id, title, artist, release_year, duration, genre) values(7002, 'Stressed Out', 'Twenty One Pilots', 2015, 5, 1);
